...
public class Ejecutor2 {
    ...
    public static void main(String[] args) {
        ...
        EstudiantePresencial[] presencial = new EstudiantePresencial[4];
        

        for (int i = 0; i < presencial.length; i++) {
            ...
            presencial[i] = new EstudiantePresencial(n, ap, ced,
                    edad, creditos, costo);
            presencial[i].calcularMatriculaPresencial();
